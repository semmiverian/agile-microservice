  ...
  return (
    <nav className="w-full bg-white flex justify-between px-6 py-3 mb-4 items-center border-b border-gray-300">
      ...
      <div className="cursor-pointer flex">
        ...
        <Link to="/localUser">
          <div className="relative mr-5">
            <span className={` ${pathname === '/localUser' ? 'text-gray-900 ' : 'text-gray-500'} hover:text-gray-900`}>
              Local User
            </span>
            {pathname === '/localUser' && (
              <div className="border border-red-300 absolute inset-x-0" style={{bottom: '-0.8rem'}}></div>
        ...
        <Link to="/subscription">
          <div className="relative mr-5">
            <span
              className={` ${pathname === '/subscription' ? 'text-gray-900 ' : 'text-gray-500'} hover:text-gray-900`}
            >
              Subscription
            </span>
